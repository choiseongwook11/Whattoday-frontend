            ...
            <header className="all">
                <div className="head-box">
                    ...
                    <div class="header-right-text-box">
                        <div className="header-right-text" onClick={() => navigate("/loginmain")}><div className="click">로그인</div></div>
                    </div>
                </div>
            </header>
                    ...
                    <div className="main-text">
                        ...
                        <div className="cal-button">
                            <div className="cal-text">
                                <div onClick={() => navigate("/login")}><div className="click">캘린더로 이동</div></div>
                            </div> 
                        </div>
                    </div>
                    <div class="main-icon">
